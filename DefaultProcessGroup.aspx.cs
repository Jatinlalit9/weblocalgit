...
{
	/// <summary>
	/// DefaultProcessGroup represents the landing page for the Process Groups.
	/// </summary>
	public class DefaultProcessGroup : PageTemplate
	{
		private void Page_Load(object sender, System.EventArgs e)
		{
			this.PageName = "DefaultProcessGroup";
			this.PageTitle = "PROCESS GROUP";
		}
		...
		override protected void OnInit(EventArgs e)
		{
			...
			//
			this.ApplicationID = Constants.eApplicationID.ProcessGroup  ;
			InitializeComponent();
			base.OnInit(e);
		}
