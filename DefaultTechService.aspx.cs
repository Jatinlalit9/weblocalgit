...
{
	/// <summary>
	/// DefaultTechService represents the landing page for the Technical services
	/// </summary>
	public class DefaultTechService : PageTemplate
	{
		private void Page_Load(object sender, System.EventArgs e)
		{
			this.PageTitle = "TECH SERVICES";
		}
		...
		override protected void OnInit(EventArgs e)
		{
			...
			//
			this.ApplicationID = eApplicationID.TechServices ;
			InitializeComponent();
			base.OnInit(e);
		}
